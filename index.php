    ...
    <div class="d-flex justify-content-center">
        <div>
            ...
            <h4 class="text-center">Organize your days in a few steps</h4>
             ...
             <div class="d-flex justify-content-between homePage mt-5 mb-5">
                <a class="linkHome" href="./view/login.html"> Login</a>
                <a class="linkHome" href="./view/registration.html">Register</a>
            </div>
        </div>
    </div>
</div>
